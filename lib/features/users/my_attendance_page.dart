  ...
  Future<void> _loadMonth(DateTime anchor) async {
    ...
    try {
      ...
      if (resp.statusCode == 200) {
        ...
        final Set<String> weekOffDates = {};
        final Set<String> holidayDates = {};
        final Set<String> halfDayDates = {};
        ...
        for (final item in data) {
          ...
          final bool isPresent =
              item['isPresent'] == true || statusText == 'present';
          ...
          if (isHoliday) {
            ...
            weekOffDates.remove(date);
            leaveDates.remove(date);
            halfDayDates.remove(date);
        ...
        final int weekOff = weekOffDates.length;
        final int holiday = holidayDates.length;
