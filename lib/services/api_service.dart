...
//       final uri = Uri.parse('${ApiService.baseUrl}$p').replace(queryParameters: query);
...
//       Uri.parse('${ApiService.baseUrl}$_otherLocPath').replace(queryParameters: qp),
//       headers: headers,
//     );
//     if (_ok(first)) {
...
//       Uri.parse('${ApiService.baseUrl}$_otherLocDecisionPath'),
...
//     };
//     final uri =
//         Uri.parse('${ApiService.baseUrl}$_myRequestsPath').replace(queryParameters: qp);
