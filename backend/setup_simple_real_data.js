...
async function setupSimpleRealData() {
  console.log('🏢 Setting up SIMPLE REAL DATA...');
  console.log('================================');
  ...
  try {
    ...
    console.log('✅ Simple real data setup completed successfully!');
    ...
    console.error('❌ Error setting up simple real data:', error);
  } finally {
