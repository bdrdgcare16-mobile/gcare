...
// // // // // // //     // Create JWT token (embed userId, email, role, empid)
// // // // // // //     const token = jwt.sign(
// // // // // // //       { userId: userDoc.id, email: user.email, role: user.role, empid: user.empid },
...
// // // // // // // // Get current user + map to employee profile
...
// // // // // // //     // 3) Lookup corresponding employee by empid
...
// // // // // // //     // 5) Return full employee record
// // // // // // //     res.json({ id: empDoc.id, ...empData });
// // // // // // //   } catch (error) {
...
// // // // // // //  * Body: { empid, name, email, password, role }
// // // // // // //  */
// // // // // // // exports.register = async (req, res) => {
// // // // // // //   const { empid, name, email, password, role } = req.body;
// // // // // // //   if (!empid || !name || !email || !password || !role) {
...
// // // // // // //   try {
// // // // // // //     // empid unique?
// // // // // // //     const byEmp = await db.collection('users').where('empid','==',empid).get();
// // // // // // //     if (!byEmp.empty) {
// // // // // // //       return res.status(400).json({ error: 'Employee ID already exists' });
// // // // // // //     }
...
// // // // // // //  */
// // // // // // // exports.forgotPassword = async (req, res) => {
// // // // // // //   // Internally same as changePassword
...
// // // // // // //     // Attempt to fetch extended employee profile
// // // // // // //     const empSnap = await db.collection('employees')
// // // // // // //                             .where('empid','==',user.empid)
// // // // // // //                             .limit(1)
// // // // // // //                             .get();

// // // // // // //     let profile = { id: doc.id, ...user };
// // // // // // //     delete profile.password;

// // // // // // //     if (!empSnap.empty) {
// // // // // // //       const emp = empSnap.docs[0].data();
// // // // // // //       delete emp.password;
// // // // // // //       profile = { ...profile, employeeProfile: emp };
// // // // // // //     }
...
// // // // // //     // Embed userId explicitly so middleware can read req.user.userId
// // // // // //     const payload = {
// // // // // //       userId: userDoc.id,
// // // // // //       email:  user.email,
// // // // // //       role:   user.role,
...
// // // // // //     // Ensure role exists, normalize, and validate
...
// // // // // //     // === IMPORTANT: expose top-level role/uid/empid/name for the frontend ===
// // // // // //     return res.json({
// // // // // //       message: 'Login successful',
// // // // // //       token,
// // // // // //       tokenType: 'Bearer',
...
// // // // // //       // nested 'user' for backward compatibility
// // // // // //       user: {
// // // // // //         id:    doc.id,
// // // // // //         name:  user.name || user.fullName || '',
// // // // // //         email: user.email,
...
// // // // // //     // Attach employee profile if present
// // // // // //     if (user.empid) {
...
// // // // //     // accept any existing hash field name
...
// // // // //       name,
// // // // //       email,
// // // // //       password: hash,               // keep field name 'password' for compatibility
// // // // //       role,
// // // // //       status,                        // active | inactive | blocked (optional)
// // // // //       createdAt: now,
// // // // //       updatedAt: now,
...
// // // // //     await db.collection(USERS_COL).doc(userDoc.id).update({
// // // // //       password:  hash,
// // // // //       passwordHash: hash,         // also update common alias fields (compat)
// // // // //       hashedPassword: hash,
// // // // //       updatedAt: new Date(),
// // // // //     });
...
// // // // // /* ======================================================================
// // // // //    NEW: Admin helpers so every registered employee can log in
// // // // //    ====================================================================== */
...
// // // // //     // already has a login?
// // // // //     const existsByEmail = await db.collection(USERS_COL).where('email', '==', email).limit(1).get();
...
// // // // //       name,
// // // // //       email,
// // // // //       password: hash,             // keep main field 'password'
// // // // //       passwordHash: hash,         // write aliases for compatibility
// // // // //       hashedPassword: hash,
// // // // //       role: 'employee',
// // // // //       status: 'active',
// // // // //       mustChangePassword: !password, // if we generated temp password
// // // // //       createdAt: now,
// // // // //       updatedAt: now,
// // // // //     });
...
// // // // // // Creates logins for all employees that have email and no user yet
...
// // // // //       created.push({ userId: ref.id, empid, email, tempPassword: temp });
// // // // //     }

// // // // //     return res.json({ message: 'Backfill complete', createdCount: created.length, created });
// // // // //   } catch (err) {
...
// // // // const okRoles = new Set(['employee', 'admin']);
// // // // const normEmail = (e = '') => String(e).trim().toLowerCase();
// // // // const issueToken = (payload) => jwt.sign(payload, JWT_SECRET, { expiresIn: JWT_EXPIRES });
...
// // // // /**
// // // //  * POST /api/auth/login
// // // //  * - Tries `users` first (normal flow)
// // // //  * - If not found, tries `employees` and migrates to `users` on success
// // // //  */
// // // // exports.login = async (req, res) => {
// // // //   const email = normEmail(req.body.email);
// // // //   const { password } = req.body;
...
// // // //     const userSnap = await db.collection(USERS_COL)
// // // //       .where('email', '==', email)
// // // //       .limit(1)
// // // //       .get();
...
// // // //     const mirrorSnap = await db.collection(USERS_COL)
// // // //       .where('email', '==', email)
// // // //       .limit(1)
// // // //       .get();
...
// // // //       name,
// // // //       email,
// // // //       password: hash,               // main field name
// // // //       passwordHash: hash,           // aliases for compatibility
// // // //       hashedPassword: hash,
// // // //       role,
...
// // // //     // Last resort: employees by email
// // // //     if (email) {
// // // //       const empSnap = await db.collection(EMPS_COL)
// // // //         .where('email','==',email).limit(1).get();
// // // //       if (!empSnap.empty) {
...
// // //     .where('email', '==', emailLower) // if already lowercased in doc, this will match
// // //     .limit(1).get();
// // //   if (!snap.empty) return snap;
...
// //     // Send via email if you have mail configured; for now we log for testing
...
// //     // Get most recent OTPs for this email (no composite index needed)
...
// //     // Find the first not-used record
// //     let doc = null, rec = null;
// //     for (const d of q.docs) {
// //       const data = d.data();
// //       if (!data.used) { doc = d; rec = data; break; }
// //     }
