...
// /**
//  * Firestore collection to store admin-defined rules
//  * Example doc:
//  *  {
//  *    id, type, shift, fromDate, toDate, allowedDays, createdBy, createdAt, active
//  *  }
//  */
...
//     const payload = {
//       id,
//       type,              // e.g. "Casual Leave"
//       shift,             // e.g. "Shift 1"
//       fromDate: s,       // Firestore Timestamp
//       toDate: e,
//       allowedDays,       // max days this type can be taken in that range
//       active: true,
//       createdBy: userId,
//       createdAt: new Date(),
//     };
...
// // GET /api/leave-types?shift=Shift%201
...
//     // active rules for a shift
//     let q = db.collection(COLL).where('active', '==', true).where('shift', '==', shift);
