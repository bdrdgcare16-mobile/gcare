...
//             // Firestore payload comes as:
//             // { docId, address, radius, latitude, longitude, timestamp }
...
//         }
//       } else {
//         _toast('Failed to fetch locations (${res.statusCode})');
//       }
//     } catch (e) {
//       _toast('Error fetching locations: $e');
//     } finally {
...
//       _toast('Add failed (${res.statusCode})');
//     } catch (e) {
//       _toast('Add error: $e');
//     }
//     return false;
...
//     try {
//       final res = await http.delete(Uri.parse('$_apiBase/office/delete/$docId'));
...
//               // Persist to backend; for simplicity, treat edit as add+reload
      ...
      if (res.statusCode == 200) {
        ...
        _locations
          ...
          ..addAll(data.map((e) {
            ...
            // { id/docId, branchName, address, radius, latitude, longitude, ... }
            final lat = (m['latitude'] as num).toDouble();
            final lng = (m['longitude'] as num).toDouble();
            final rad = (m['radius'] as num).toDouble();
            return LocationModel(
