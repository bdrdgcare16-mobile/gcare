...
// //      final token = html.window.localStorage['token']; // Read the saved token
...
// //     final res = await http.get(Uri.parse('$apiBase/api/employees'), headers: _headers());
// //     if (res.statusCode == 200) {
// //       final data = jsonDecode(res.body) as List<dynamic>;
// //       return data.map((e) => Employee.fromServer(e as Map<String, dynamic>)).toList();
// //     }
...
// //       Uri.parse('$apiBase/api/employees'),
// //       headers: _headers(),
// //       body: body,
// //     );
// //     if (res.statusCode == 201) {
// //       final j = jsonDecode(res.body) as Map<String, dynamic>;
// //       return (j['id'] ?? '').toString(); // Firestore doc id
// //     }
// //     throw Exception('Create failed (${res.statusCode}): ${res.body}');
// //   }

// //   // Optional update hook (UI already has Edit button)
// //   static Future<void> updateEmployee(String docId, Map<String, dynamic> updates) async {
// //     final res = await http.put(
// //       Uri.parse('$apiBase/api/employees/$docId'),
// //       headers: _headers(),
...
// //       });
// //     } catch (e) {
// //       // You can show a SnackBar if you like (UI unchanged otherwise)
...
// //                 statButton('Active', countStatus('Active'), kButtonColor),
// //                 statButton('Inactive', countStatus('Inactive'), kButtonColor),
// //                 statButton('Suspended', 0, kButtonColor), // not in DB yet
// //                 statButton('Relived', 0, kButtonColor),   // not in DB yet
// //               ],
// //             ),
// //             const SizedBox(height: 10),
// //             Column(
...
// //                 ElevatedButton(
// //                   onPressed: () async {
// //                     // Open form; it returns an Employee object (with password)
// //                     final result = await Navigator.push<Employee>(
// //                       context,
// //                       MaterialPageRoute(builder: (_) => const CreateEmployeeScreen()),
// //                     );
// //                     if (result != null) {
// //                       // POST to backend, then refresh list from DB
// //                       try {
...
// //                                         icon: const Icon(Icons.delete, color: Colors.red),
// //                                         onPressed: () {
// //                                           // No DELETE endpoint in your controller.
// //                                           // Keeping UI behavior (local remove).
// //                                           setState(() {
...
// //                                           );
// //                                           if (edited != null) {
// //                                             // If you want to persist edits, call update with server docId
// //                                             if (e.docId != null) {
// //                                               try {
...
// //       id.text = emp.id;
// //       email.text = emp.email;
// //       // strip any +CC prefix if present
// //       mobile.text = emp.mobile.replaceFirst(RegExp(r'^\+\d+\s*'), '');
// //       shiftgroup.text = emp.shiftGroup;
// //       location.text = emp.location;
// //       dept.text = emp.dept;
...
// // // Dummy page reference to keep your import working
// // class ReportSchedulerPage extends StatelessWidget {
// //   const ReportSchedulerPage({super.key});
// //   @override
// //   Widget build(BuildContext context) => const Scaffold(body: Center(child: Text('Report Scheduler')));
// // }
// import 'dart:convert';
// import 'package:flutter/material.dart';
// import 'package:intl_phone_field/intl_phone_field.dart';
...
//   static Map<String, String> _headers() {
//     // UPDATED: read token and send in BOTH common headers
