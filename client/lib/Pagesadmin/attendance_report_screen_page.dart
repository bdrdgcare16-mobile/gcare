...
// // //   });
// // // }
// // // Pagesadmin/attendance_report_screen_page.dart
// // // Limit page — now fetches real data from API (range-summary), no more dummy rows.
...
// //   // ------- API fetch (same backend as your working page) -------
...
// //   // ------- filtering & counts (same labels you already show) -------
// //   bool _matchesFilter(AttendanceRecord record, String filter) {
// //     switch (filter) {
// //       case 'Present':
// //         return record.attendance == 'Present';
...
// //                               // Summary Cards (counts computed from fetched rows)
// //                               Container(
// //                                 padding: EdgeInsets.symmetric(horizontal: isWeb ? 16 : 12),
// //                                 child: LayoutBuilder(
// //                                   builder: (context, constraints) {
...
// //                                   scrollDirection: Axis.horizontal,
// //                                   child: SizedBox(
// //                                     width: isWeb ? 690 : 690, // keep your original sizing
// //                                     child: Column(
// //                                       children: [
// //                                         // Header Row
// //                                         Container(
...
// //   // ------- small UI pieces (unchanged styles) -------
// //   Widget _buildHeaderCell(String text, double width, bool isWeb) {
// //     return SizedBox(
// //       width: width,
// //       child: Text(
...
// // // Data model (same fields your UI uses)
// // class AttendanceRecord {
// //   final String employeeId;
// //   final String employeeName;
// //   final String shift;
...
// import 'package:excel/excel.dart' as xls;         // <-- added
// import 'package:file_saver/file_saver.dart';      // <-- added
...
//       // Meta rows (exactly like your screenshot)
//       sheet.appendRow(List<dynamic>.from(['Attendance', 'Reports']));

//       String two(int n) => n.toString().padLeft(2, '0');
//       final now = DateTime.now();
//       final generatedAt =
//           '${two(now.day)}/${two(now.month)}/${now.year} ${two(now.hour)}:${two(now.minute)}';
//       sheet.appendRow(List<dynamic>.from(['Generated', generatedAt]));

//       // Headers
//       final headers = <String>[
//         'Employee ID','Employee Name','Shift','Date','CheckIn','CheckOut','Department','Attendance','Worked Hours'
//       ];
//       const headerRowIndex = 2; // after 2 meta rows
...
//       // Styles: header lavender + bold; body normal white
//       final headerStyle = xls.CellStyle(
//         bold: true,
//         backgroundColorHex: '#FFD1C4E9',
...
//       final fileName = 'attendance_${ymd(_fromDate)}${_ymd(_toDate)}.xlsx';
...
//                                     Expanded(
//                                       child: ElevatedButton.icon(
//                                         onPressed: _downloadReport, // <-- now downloads Excel
//                                         icon: Icon(
//                                           Icons.download,
//                                           size: isWeb ? 16 : 14,
//                                           color: kButtonColor,
