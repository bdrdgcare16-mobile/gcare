...
//       final uri = hasEmp
//           ? Uri.parse('$_apiBase/api/tasks/upload')
//           : Uri.parse('$_apiBase/api/tasks/broadcast');
...
//         ? Uri.parse('$_apiBase/api/tasks?empid=$empid')
//         : Uri.parse('$_apiBase/api/tasks?audience=all');

//     Future<bool> try(Uri u) async {
...
//     try {
//       final ok = await try(uri);
//       if (!ok && empid.isNotEmpty) {
//         await try(Uri.parse('$_apiBase/api/tasks?audience=all'));
//       }
//     } catch (e) {
...
class _MyTasksPageState extends State<MyTasksPage> {
  ...
  Future<void> _fetchTasksIfNeeded() async {
    ...
    try {
      ...
      if (!ok && empid.isNotEmpty) {
        await tryFetch(Uri.parse('$_apiBase/api/tasks?audience=all'));
      }
    } catch (e) {
      setState(() => _tasksError = 'Failed to fetch tasks: $e');
    } finally {
