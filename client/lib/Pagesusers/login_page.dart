...
// // ✅ Password reset success page hosted on Firebase Hosting
// const String _kPasswordResetContinueUrl = 'https://servappbackend.web.app';
...
//   // ---------- FORGOT PASSWORD (Reset link version) ----------
...
//             try {
//               // Explicitly include Continue URL to ensure redirect to your success page.
//               final settings = ActionCodeSettings(
//                 url: _kPasswordResetContinueUrl,
//                 handleCodeInApp: false, // we land on the hosted page, not in-app
//               );
...
//                   userName: email.split('@').first, employeeDocId: '')));
//         }
//       } else {
//         final msg =
...
//             child: CustomPaint(
//               painter: _ArcPainter(color: widget.color, strokeWidth: widget.strokeWidth),
//             ),
//           );
//         },
//       ),
