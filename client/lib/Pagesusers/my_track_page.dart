...
double _distM(LatLng a, LatLng b) {
  ...
  final aa = s1*s1 + (a.latitude*(3.14159/180.0)).cos()*(b.latitude*(3.14159/180.0)).cos()*s2*s2;
...
class _MyTrackPageState extends State<MyTrackPage> {
  ...
  List<_TrackPoint> _simplifyByDistance(List<_TrackPoint> points, {double minMeters = 10}) {
