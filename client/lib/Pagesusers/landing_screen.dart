...
//   void initState() {
//     super.initState();
//     // Defer flow decision until after first frame to avoid build-time nav errors.
//     WidgetsBinding.instance.addPostFrameCallback((_) => _decideFlow());
//   }
...
//   // Web -> login; Android -> biometric; others -> login
//   void _decideFlow() {
//     if (kIsWeb) {
...
//         // Stay on this screen. Do not navigate to login.
//         return;
//       }
...
//           stickyAuth: true,
//           biometricOnly: true, // fingerprint/face only
//         ),
//       );

//       if (didAuthenticate) {
//         if (mounted) {
//           setState(() => _statusMessage = 'Authenticated');
//         }
//         _safeNavigateToLogin(); // Only on success
//       } else {
...
//     // Defer SnackBar to after frame to avoid build-time exceptions.
