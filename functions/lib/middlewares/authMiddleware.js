...
exports.isAdmin = exports.verifyToken = exports.roleMiddleware = exports.authMiddleware = void 0;
...
const isAdmin = (req, res, next) => (0, exports.roleMiddleware)(['admin'])(req, res, next);
