...
export const authMiddleware = async (
  ...
  try {
    ...
    console.log('JWT_SECRET present in middleware:', !!process.env.JWT_SECRET);
    console.log('JWT_SECRET length in middleware:', (process.env.JWT_SECRET || '').length);
    console.log('Incoming token preview:', token?.slice(0, 20));
